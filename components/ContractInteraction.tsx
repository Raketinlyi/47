...
import { CheckCircle2, Copy, ExternalLink, Flame, Heart, Loader2, Trophy, Zap } from 'lucide-react';
        ...
        <Card className='bg-slate-900/50 border-green-500/30'>
          ...
          <CardContent>
            <Badge className='bg-green-500/20 text-green-400'>
              <CheckCircle2 className="w-4 h-4 inline mx-1" /> {t('wallet.connected', 'Connected')}
            </Badge>
          </CardContent>
        </Card>
      </div>
                ...
                <div className='flex items-center justify-between'>
                  ...
                  <div className='flex items-center gap-2'>
                    {isConfirming ? (
                      ...
                      <Badge className='bg-green-500/20 text-green-400'>
                        <CheckCircle2 className="w-4 h-4 inline mx-1" /> Confirmed
                      </Badge>
                    ) : null}
                    <Button
                      size='sm'
