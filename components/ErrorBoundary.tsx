        ...
        <Card className='max-w-md mx-auto mt-8 border-red-500/50 bg-red-900/20'>
          ...
          <CardContent className='space-y-4'>
            ...
            <div className='flex gap-2'>
              ...
              <Button
                onClick={() => {
                  // РњСЏРіРєРёР№ reset СЃРѕСЃС‚РѕСЏРЅРёСЏ Р±РµР· РїРµСЂРµР·Р°РіСЂСѓР·РєРё СЃС‚СЂР°РЅРёС†С‹
  ...
  const fallback = (
    <Card className='border-orange-500/50 bg-orange-950/20'>
      ...
      <CardContent>
        ...
        <Button
          onClick={() => {
            // РњСЏРіРєРёР№ reset СЃРѕСЃС‚РѕСЏРЅРёСЏ Рё РѕР±РЅРѕРІР»РµРЅРёРµ РґР°РЅРЅС‹С…
            queryClient.invalidateQueries();
            // РџРµСЂРµСЂРµРЅРґРµСЂ РєРѕРјРїРѕРЅРµРЅС‚Р°
