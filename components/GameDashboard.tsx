  ...
  if (!isConnected) {
    return (
      <div className='text-center py-12'>
        ...
        >
          <Wallet className='w-16 h-16 mb-4 text-slate-600 mx-auto' />
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-4 text-sm'>
              <div>
                <h4 className='font-semibold text-orange-300 mb-2 flex items-center gap-2'>
                  <Zap className='w-4 h-4' /> Ping System
                </h4>
              ...
              <div>
                <h4 className='font-semibold text-red-300 mb-2 flex items-center gap-2'>
                  <Flame className='w-4 h-4' /> Burn System
                </h4>
                <ul className='text-slate-400 space-y-1'>
              ...
              <div>
                <h4 className='font-semibold text-pink-300 mb-2 flex items-center gap-2'>
                  <Heart className='w-4 h-4' /> Breeding System
                </h4>
                <ul className='text-slate-400 space-y-1'>
              ...
              <div>
                <h4 className='font-semibold text-green-300 mb-2 flex items-center gap-2'>
                  <Coins className='w-4 h-4' /> Reward System
                </h4>
                <ul className='text-slate-400 space-y-1'>
