...
import { AlchemyNFT, getTokenIdAsDecimal } from '@/hooks/useUserNFTs';
import {
  useCrazyOctagonGame,
  type NFTGameData,
  type BurnRecord,
        ...
        <CardHeader>
          <div className='aspect-square relative overflow-hidden rounded-lg burned-img'>
            <IpfsImage
              ...
              tokenId={tokenIdDec} // РџРµСЂРµРґР°РµРј tokenId РґР»СЏ Р»РѕРєР°Р»СЊРЅРѕРіРѕ РёР·РѕР±СЂР°Р¶РµРЅРёСЏ
            />
