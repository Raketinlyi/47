...
import { AlertTriangle, CheckCircle, RefreshCw, Rocket } from 'lucide-react';
        ...
        <div className='flex items-center gap-3'>
          ...
          <div>
            ...
            <p className='text-green-200 text-sm'>
              You&apos;re ready to use CrazyCube dApp! <Rocket className="w-4 h-4 inline mx-1" />
            </p>
          </div>
        </div>
      </motion.div>
        ...
        <div className='flex items-center gap-3'>
          ...
          <div>
            ...
            <p className='text-red-200 text-sm'>
              Please switch to Monad Mainnet to use this dApp
            </p>
          </div>
        </div>
        <Button
