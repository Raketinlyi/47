      ...
      >
        ...
        <div className='relative z-10 text-center space-y-6'>
          ...
          <motion.div {...blinkAnimation}>
            <h2 className='text-3xl font-extrabold text-transparent bg-gradient-to-r from-yellow-300 via-pink-300 to-purple-300 bg-clip-text mb-2 flex items-center justify-center gap-2'>
            ...
            >
              ...
              <Gem className='inline w-5 h-5 ml-1 text-blue-400' />
            </motion.p>
          </motion.div>
          ...
          >
            ...
            <div className='text-yellow-200 font-semibold'>
              <div>
                ...
                {t('social.exclusiveNFTs', 'Exclusive NFTs')}
              </div>
              <div>
              ...
              <div>
                ...
                {t('social.discordRoles', 'Special Discord roles')}
              </div>
              <div>
          ...
          <div className='space-y-3'>
            ...
            >
              ...
              <Smartphone className='inline w-6 h-6 mr-3' />
            ...
            <div className='space-y-3'>
              ...
              <div className='grid grid-cols-1 gap-3'>
                ...
                >
                  ...
                  {t(
                    'social.followTwitter',
                    'Follow @crazy_octagon (x.com/crazy_octagon)'
                  )}
                </motion.a>
          ...
          >
            <div className='text-yellow-200 font-bold text-base flex items-center justify-center gap-2'>
