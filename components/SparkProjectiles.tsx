  ...
  useEffect(() => {
    ...
    return () =>
      window.removeEventListener(
        'crazycube:spark-burst',
        onBurst as EventListener
      );
  }, []);
...
function launchDot(
  ...
  dot.style.background =
    'radial-gradient(circle, rgba(56,189,248,1) 0%, rgba(14,165,233,0.9) 60%, rgba(59,130,246,0.7) 100%)';
  dot.style.boxShadow =
    '0 0 12px rgba(56,189,248,0.9), 0 0 24px rgba(14,165,233,0.8)';
  ...
  const keyframes = [
    {
      transform: `translate(${fromX - 4}px, ${fromY - 4}px)`,
      offset: 0,
      opacity: 1,
    },
    {
      transform: `translate(${midX - 4}px, ${midY - 4}px)`,
      offset: 0.6,
      opacity: 1,
    },
    {
      transform: `translate(${toX - 4}px, ${toY - 4}px)`,
      offset: 1,
      opacity: 0.7,
    },
  ];
...
// FisherвЂ“Yates shuffle with strict typing (no destructuring swap to appease TS)
