...
import { Gamepad2, Activity, Rocket, DoorOpen } from 'lucide-react';
  ...
  return (
    <div className='relative w-full h-screen'>
      ...
      <div className='absolute top-4 left-4 bg-black/70 text-green-400 p-3 rounded font-mono text-sm'>
        <div>
           Cubie Detective: X: {playerPos.x}, Y: {playerPos.y}, Z:{' '}
          {playerPos.z}
        </div>
        <div className='mt-2 text-cyan-400'>
          <Gamepad2 className="w-4 h-4 inline mx-1" /> WASD: Move | Space: Jump | Shift: Run | ESC: Exit
        </div>
        ...
        <div className='absolute inset-0 bg-black/80 flex items-center justify-center'>
          <div className='text-center text-white p-8 bg-slate-800/90 rounded-xl max-w-md'>
            <h2 className='text-2xl font-bold mb-4 text-cyan-400'>
              рџЊЊ CrazyCube World
            </h2>
            <div className='space-y-3 text-left mb-6'>
              <div>
                <Gamepad2 className="w-4 h-4 inline mx-1" /> <strong>WASD</strong> - Move
              </div>
              <div>
                <Rocket className="w-4 h-4 inline mx-1" /> <strong>Space</strong> - Jump
              </div>
              <div>
                <Activity className="w-4 h-4 inline mx-1" /> <strong>Shift</strong> - Run
              </div>
              <div>
                <strong>Mouse</strong> - Look
              </div>
              <div>
                <DoorOpen className="w-4 h-4 inline mx-1" /> <strong>ESC</strong> - Exit
              </div>
            </div>
            ...
            >
              <Rocket className="w-4 h-4 inline mx-1" /> Enter the World
            </button>
          </div>
        </div>
      )}
