...
interface HeartRainProps {
  /** Amount of hearts per 100 vw (в‰€ screen width). Default = 6 */
  density?: number;
...
/**
 * Fixed layer that drops little heart SVGs from the top of the viewport.
 * Pure CSS/JS вЂ” no canvas, so almost free for the GPU; each heart is an absolutely-positioned
