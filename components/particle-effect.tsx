...
interface ParticleEffectProps {
   ...
   * "random" вЂ“ current behaviour (edges/random on screen).
   * "center" вЂ“ spawn from the centre of the canvas and fly outwards.
   */
  ...
  const createParticle = useCallback(
    (
      ...
      if (origin === 'center') {
        ...
        // Original behaviour вЂ“ edges or anywhere
