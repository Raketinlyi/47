...
export function UnderConstruction() {
  ...
  const { getTransition } = useAnimationSystem();

  // Helper function to create framer-motion compatible transitions
  const createFramerTransition = (
    type: 'transform' | 'opacity' | 'scale' | 'all' = 'all',
    overrides?: any
  ) => {
    const baseTransition = getTransition(type);
    ...
    return {
      ...baseTransition,
      ease: easingMap[baseTransition.ease] || easeInOut,
      ...overrides,
    };
  };
    ...
    <div className='min-h-[80vh] flex flex-col items-center justify-center p-4'>
      ...
      <div className='relative'>
        ...
        <motion.div
          ...
          transition={createFramerTransition('transform', {
        ...
        <motion.div
          className='relative'
          animate={{ y: [0, -10, 0] }}
          transition={createFramerTransition('all', {
            repeat: Number.POSITIVE_INFINITY,
          })}
        >
          {/* Construction hat */}
      ...
      >
        ...
        <div className='relative z-10'>
          ...
          <motion.div
            ...
            transition={createFramerTransition('scale', {
              repeat: Number.POSITIVE_INFINITY,
            })}
          >
