...
export function ContractFullStats() {
  ...
  const poolStats = [
    ...
    {
      title: 'Current Share / Ping',
      value: `${parseFloat(contractStats.sharePerPing).toFixed(2)} CRAA`,
      icon: TrendingUp,
      color: 'yellow',
    },
    {
      title: 'Safety Reserve',
      value: `${(contractStats.safetyBps / 100).toFixed(1)}%`,
      icon: Shield,
      color: 'blue',
    },
  ];
  ...
  const configStats = [
    ...
    },
    {
      ...
      value: formatSeconds(contractStats.sweepInterval),
      icon: Clock,
      color: 'slate',
    },
    {
      title: 'Month Duration',
      value: formatSeconds(contractStats.monthDuration),
      icon: Calendar,
      color: 'indigo',
    },
    {
      title: 'Reward Cap Divisor',
      value: `1/${contractStats.perPingCapDivisor}`,
      icon: Target,
      color: 'pink',
    },
  ];
    ...
    <div className='space-y-8'>
      ...
      <div className='text-center mt-8'>
        <p className='text-slate-400 text-sm'>
          Data retrieved directly from CrazyCubeUltimate3_Safe contract on Monad
          Mainnet. Last updated:{' '}
